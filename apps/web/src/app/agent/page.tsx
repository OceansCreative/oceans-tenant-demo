...
export const metadata: Metadata = {
  title: "不動産会社ポータル",
  description: "OceansTenant 不動産会社向け管理画面",
};

const AgentDashboardPage = (): React.JSX.Element => {
  ...
  return (
    <div className="container-page py-10">
      <header className="mb-8 flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900">不動産会社ポータル</h1>
          <p className="text-sm text-neutral-600">
            デモのため固定の会社 {myCompanyRef} を表示しています。
          </p>
        </div>
        <Link
      ...
      <section className="mt-10 space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-neutral-900">自社物件</h2>
          <Link
